module.exports = {
	...
	cookieSecret: "VibeMusicIsEpic", //- Cookie Secret
	website: process.env.WEBSITE || "http://localhost:4200", //- without the / at the end
	// You need a lavalink server for this bot to work!!!!
	// Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
	nodes: [
		{
			identifier: process.env.LAVALINK_ID || "Main Node", //- Used for indentifier in stats commands.
			host: process.env.LAVALINK_HOST || "lavalink.example.com", //- The host name or IP of the lavalink server.
	...
	embedColor: "#FF00FF", //- Color of the embeds, hex supported
	presence: {
		...
		activities: [
			{
				name: "VibeMusic", //- Status Text
				type: "LISTENING", //- PLAYING, WATCHING, LISTENING, STREAMING
			},
		],
	},
	iconURL: "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExM3Z5eGk5eHl5eHl5eHl5eHl5eHl5eHl5eHl5eHl5eHl5eHl5eHl5/xT9IgG50Fb7Mi0prBC/giphy.gif", //- This icon will be in every embed's author field
};
