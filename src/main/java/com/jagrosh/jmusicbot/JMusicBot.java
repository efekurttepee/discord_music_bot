...
import pw.chew.jdautilities.command.CommandClient;
import pw.chew.jdautilities.command.CommandClientBuilder;
import pw.chew.jdautilities.commons.waiter.EventWaiter;
import pw.chew.jdautilities.examples.command.*;
...
public class JMusicBot 
{
    ...
    private static void startBot()
    {
        ...
        Prompt prompt = new Prompt("VibeMusic");
    ...
    private static CommandClient createCommandClient(BotConfig config, SettingsManager settings, Bot bot)
    {
        ...
        AboutCommand aboutCommand = new AboutCommand(Color.MAGENTA,
                                "Kolayca kurulabilen bir müzik botu! (v" + OtherUtil.getCurrentVersion() + ")",
                                new String[]{"Yüksek Kaliteli Müzik", "FairQueue™ Teknolojisi", "Kendi Sunucunda Barındır"},
                                RECOMMENDED_PERMS);
